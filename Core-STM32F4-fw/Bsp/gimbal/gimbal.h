...
#define GIMBAL_DATA_SEND_SHORT_NUM          ((uint8_t)3)
#define GIMBAL_DATA_SEND_CHAR_NUM          ((uint8_t)5)
#define GIMBAL_DATA_RECEIVE_FLOAT_NUM       ((uint8_t)7)
#define GIMBAL_DATA_RECEIVE_CHAR_NUM       ((uint8_t)0)
