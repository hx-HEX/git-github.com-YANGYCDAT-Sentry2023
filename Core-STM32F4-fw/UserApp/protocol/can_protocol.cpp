    ...
    if(context->CANx == CAN1){
        switch(context->CANx_RxMsg.StdId)
        {
            case (0x200 + CHASSIS_FRL_MOTOR_ID):	
                ...
                break;
            case (0x204 + CHASSIS_FRA_MOTOR_ID):	
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_FRA_MOTOR]->
                EncoderAngleUpdate(GetEncoderNumber(&(context->CANx_RxMsg.Data[0])));
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_FRA_MOTOR]->
                EncoderSpeedUpdate(GetMotorSpeed(&(context->CANx_RxMsg.Data[0])));
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_FRA_MOTOR]->m_state_update_times++;
                break;              
            
            case (0x204 + CHASSIS_BRA_MOTOR_ID):	
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_BRA_MOTOR]->
                EncoderAngleUpdate(GetEncoderNumber(&(context->CANx_RxMsg.Data[0])));
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_BRA_MOTOR]->
                EncoderSpeedUpdate(GetMotorSpeed(&(context->CANx_RxMsg.Data[0])));
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_BRA_MOTOR]->m_state_update_times++;
                break;
            case (0x200 + CHASSIS_BRL_MOTOR_ID):	
                ...
                break;
            case (0x200 + SHOOT_DRIVE_MOTOR_ID):	
                G_sentry.shoot_motor[SentryRobot::SHOOT_DRIVE_MOTOR]->
                EncoderAngleUpdate(GetEncoderNumber(&(context->CANx_RxMsg.Data[0])));
                G_sentry.shoot_motor[SentryRobot::SHOOT_DRIVE_MOTOR]->
                EncoderSpeedUpdate(GetMotorSpeed(&(context->CANx_RxMsg.Data[0])));
                G_sentry.shoot_motor[SentryRobot::SHOOT_DRIVE_MOTOR]->m_state_update_times++;
                break;
        }
    }
        ...
        switch(context->CANx_RxMsg.StdId)
        {
            case 0x400:  
                ...
                break;
            case (0x204 + FIRST_GIMBAL_YAW_MOTOR_ID):	
                G_sentry.gimbal_motor[SentryRobot::GIMBAL_FIRST_YAW_MOTOR]->
                EncoderAngleUpdate(GetEncoderNumber(&(context->CANx_RxMsg.Data[0])));
                G_sentry.gimbal_motor[SentryRobot::GIMBAL_FIRST_YAW_MOTOR]->
                EncoderSpeedUpdate(GetMotorSpeed(&(context->CANx_RxMsg.Data[0])));
                G_sentry.gimbal_motor[SentryRobot::GIMBAL_FIRST_YAW_MOTOR]->m_state_update_times++;
                break;
            ...
            case (0x200 + CHASSIS_BLL_MOTOR_ID):	
                ...
                break;
            case (0x204 + CHASSIS_FLA_MOTOR_ID):	
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_FLA_MOTOR]->
                EncoderAngleUpdate(GetEncoderNumber(&(context->CANx_RxMsg.Data[0])));
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_FLA_MOTOR]->
                EncoderSpeedUpdate(GetMotorSpeed(&(context->CANx_RxMsg.Data[0])));
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_FLA_MOTOR]->m_state_update_times++;
                break;
            case (0x204 + CHASSIS_BLA_MOTOR_ID):	
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_BLA_MOTOR]->
                EncoderAngleUpdate(GetEncoderNumber(&(context->CANx_RxMsg.Data[0])));
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_BLA_MOTOR]->
                EncoderSpeedUpdate(GetMotorSpeed(&(context->CANx_RxMsg.Data[0])));
                G_sentry.chassis_steer_motor[G_sentry.CHASSIS_BLA_MOTOR]->m_state_update_times++;
                break;
        }
    }
}
